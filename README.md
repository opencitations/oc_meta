...
The configuration file is a YAML file with the following keys (an example can be found in [`config/meta_config.yaml`](https://github.com/opencitations/meta/blob/master/oc_meta/config/meta_config.yaml)).
...
The configuration file is a YAML file with the following keys (an example can be found in [`config/crossref_config.yaml`](https://github.com/opencitations/meta/blob/master/oc_meta/config/crossref_config.yaml)).
