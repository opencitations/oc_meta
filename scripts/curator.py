...
class DeduplicationDecisionTree:
    def __init__(self, col_name:str, indexes:Indexes):
    ...
    def create_new_entity(name:str):
        pass

    def update_entity_with_ts_data():
        pass

    def raise_conflict_between_meta_ids():
        pass

    def merge_entities_with_ts(entity_a, entity_b, ts):
        pass

    def merge_entities(entity_a, entity_b:list):
        pass
    
    def raise_conflict_between_ids():
        pass
