...
def finder():
    ...
    finder.get_everything_about_res(
        metavals={
            "omid:br/2373",
            "omid:br/2380",
            "omid:br/2730",
        ...
        identifiers={"doi:10.1001/.391", "orcid:0000-0001-6994-8412"},
        vvis=set(),
    )
    return finder
...
class TestResourceFinder:
    ...
    def test_retrieve_ra_from_meta_with_orcid(self, finder):
        ...
        expected_output = (
            "Alarcon, Louis H.",
            [("id/4475", "orcid:0000-0001-6994-8412")],
            True,
        )
        assert output == expected_output
    ...
    def test_retrieve_ra_sequence_from_br_meta(self, finder):
        ...
        expected_output = [
            ...
            {"ar/5345": ("Kirsch, Thomas D.", [], "ra/3318")},
            {
                "ar/5346": (
                    "Kelen, Gabor D.",
                    [("id/4278", "orcid:0000-0002-3236-8286")],
                    "ra/3319",
                )
            },
        ]
    ...
    def test_retrieve_ra_sequence_from_br_meta_over_10000_roles(self):
        finder = ResourceFinder("", "https://w3id.org/oc/meta/")
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/8888"
        role_count = 10001

        for index in range(1, role_count + 1):
            ar_uri = f"{base_iri}/ar/{880000 + index}"
            ra_uri = f"{base_iri}/ra/{990000 + index}"
            finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar_uri)
            finder.add_triple(ar_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
            finder.add_triple(ar_uri, GraphEntity.iri_is_held_by, ra_uri)
            finder.add_triple(ra_uri, GraphEntity.iri_name, f"Author {index}")
            if index < role_count:
                finder.add_triple(
                    ar_uri,
                    GraphEntity.iri_has_next,
                    f"{base_iri}/ar/{880000 + index + 1}",
                )

        output = finder.retrieve_ra_sequence_from_br_meta("br/8888", "author")
        expected_output = [
            {f"ar/{880000 + index}": (f"Author {index}", [], f"ra/{990000 + index}")}
            for index in range(1, role_count + 1)
        ]
        assert output == expected_output
    ...
    def test_retrieve_ra_sequence_with_loop(self, finder):
        ...
        """
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9999"
        # Use AR numbers where 9992 < 9991 to verify sorting works correctly
        ar1_uri = f"{base_iri}/ar/9992"
        ar2_uri = f"{base_iri}/ar/9991"
        ra1_uri = f"{base_iri}/ra/9981"
        ra2_uri = f"{base_iri}/ra/9982"
        ...
        finder.add_triple(ra1_uri, GraphEntity.iri_given_name, "John")
        finder.add_triple(ra1_uri, GraphEntity.iri_family_name, "Doe")
        ...
        finder.add_triple(ra2_uri, GraphEntity.iri_given_name, "Jane")
        finder.add_triple(ra2_uri, GraphEntity.iri_family_name, "Smith")
    ...
    def test_retrieve_ra_sequence_with_self_reference(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9998"
        ar1_uri = f"{base_iri}/ar/9981"
        ra1_uri = f"{base_iri}/ra/9971"
        # Create AR that points to itself
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_has_next, ar1_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Test Publisher")
    ...
    def test_retrieve_ra_sequence_with_invalid_next(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9997"
        ar1_uri = f"{base_iri}/ar/9971"
        ar2_uri = f"{base_iri}/ar/9972"
        ar_invalid_uri = f"{base_iri}/ar/9999"
        ra1_uri = f"{base_iri}/ra/9961"
        ra2_uri = f"{base_iri}/ra/9962"
        ...
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Author One")

        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar2_uri)
        finder.add_triple(ar2_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar2_uri, GraphEntity.iri_is_held_by, ra2_uri)
        finder.add_triple(ra2_uri, GraphEntity.iri_name, "Author Two")
    ...
    def test_retrieve_ra_sequence_with_missing_is_held_by(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9996"
        ar1_uri = f"{base_iri}/ar/9961"
    ...
    def test_retrieve_ra_sequence_with_multiple_next_values(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9995"
        ar1_uri = f"{base_iri}/ar/9951"
        ar2_uri = f"{base_iri}/ar/9952"
        ar3_uri = f"{base_iri}/ar/9953"
        ra1_uri = f"{base_iri}/ra/9941"
        ra2_uri = f"{base_iri}/ra/9942"
        ra3_uri = f"{base_iri}/ra/9943"
        ...
        finder.add_triple(ra3_uri, GraphEntity.iri_name, "Author Three")
    ...
    def test_retrieve_ra_sequence_no_ars_for_role(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9994"
        ar1_uri = f"{base_iri}/ar/9941"
        ra1_uri = f"{base_iri}/ra/9931"
        # Create BR with editor, but request author
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_editor)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Editor Name")
    ...
    def test_retrieve_ra_sequence_single_ar_no_chain(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9993"
        ar1_uri = f"{base_iri}/ar/9931"
        ra1_uri = f"{base_iri}/ra/9921"
        # Create single AR without next
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Single Author")
    ...
    def test_retrieve_ra_sequence_two_independent_chains(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9992"
        # Chain 1: AR1 -> AR2 (length 2)
        ar1_uri = f"{base_iri}/ar/9921"
        ar2_uri = f"{base_iri}/ar/9922"
        ra1_uri = f"{base_iri}/ra/9911"
        ra2_uri = f"{base_iri}/ra/9912"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_has_next, ar2_uri)
        ...
        ar3_uri = f"{base_iri}/ar/9923"
        ra3_uri = f"{base_iri}/ra/9913"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar3_uri)
        finder.add_triple(ar3_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar3_uri, GraphEntity.iri_is_held_by, ra3_uri)
        finder.add_triple(ra3_uri, GraphEntity.iri_name, "Author Three")
    ...
    def test_retrieve_ra_sequence_equal_length_chains_tiebreaker(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9986"
        # Chain 1: AR 9935 -> AR 9936 (length 2, starts with higher number)
        ar1_uri = f"{base_iri}/ar/9935"
        ar2_uri = f"{base_iri}/ar/9936"
        ra1_uri = f"{base_iri}/ra/9925"
        ra2_uri = f"{base_iri}/ra/9926"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_has_next, ar2_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Author A")

        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar2_uri)
        finder.add_triple(ar2_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar2_uri, GraphEntity.iri_is_held_by, ra2_uri)
        finder.add_triple(ra2_uri, GraphEntity.iri_name, "Author B")

        # Chain 2: AR 9933 -> AR 9934 (length 2, starts with lower number)
        ar3_uri = f"{base_iri}/ar/9933"
        ar4_uri = f"{base_iri}/ar/9934"
        ra3_uri = f"{base_iri}/ra/9923"
        ra4_uri = f"{base_iri}/ra/9924"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar3_uri)
        finder.add_triple(ar3_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar3_uri, GraphEntity.iri_is_held_by, ra3_uri)
        finder.add_triple(ar3_uri, GraphEntity.iri_has_next, ar4_uri)
        finder.add_triple(ra3_uri, GraphEntity.iri_name, "Author C")
        ...
        finder.add_triple(ra4_uri, GraphEntity.iri_name, "Author D")
    ...
    def test_retrieve_ra_sequence_editor_role(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9991"
        ar1_uri = f"{base_iri}/ar/9911"
        ra1_uri = f"{base_iri}/ra/9901"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_editor)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Editor Name")
    ...
    def test_retrieve_ra_sequence_publisher_role(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9990"
        ar1_uri = f"{base_iri}/ar/9901"
        ra1_uri = f"{base_iri}/ra/9891"
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_publisher)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Publisher Name")
    ...
    def test_retrieve_ra_sequence_three_node_loop(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9989"
        ar1_uri = f"{base_iri}/ar/9891"
        ar2_uri = f"{base_iri}/ar/9892"
        ar3_uri = f"{base_iri}/ar/9893"
        ra1_uri = f"{base_iri}/ra/9881"
        ra2_uri = f"{base_iri}/ra/9882"
        ra3_uri = f"{base_iri}/ra/9883"
    ...
    def test_retrieve_ra_sequence_duplicate_ra(self, finder):
        ...
        base_iri = "https://w3id.org/oc/meta"
        br_uri = f"{base_iri}/br/9988"
        ar1_uri = f"{base_iri}/ar/9881"
        ar2_uri = f"{base_iri}/ar/9882"
        ra1_uri = f"{base_iri}/ra/9871"
        # Two ARs pointing to same RA (duplicate author)
        finder.add_triple(br_uri, GraphEntity.iri_is_document_context_for, ar1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_with_role, GraphEntity.iri_author)
        finder.add_triple(ar1_uri, GraphEntity.iri_is_held_by, ra1_uri)
        finder.add_triple(ar1_uri, GraphEntity.iri_has_next, ar2_uri)
        finder.add_triple(ra1_uri, GraphEntity.iri_name, "Same Author")
    ...
    def test_retrieve_venue_from_local_graph(self, finder):
        ...
        venue_uri = f"{base_iri}/br/8001"
        volume_uri = f"{base_iri}/br/8002"
        issue_uri = f"{base_iri}/br/8003"
        # Venue
        finder.add_triple(
            venue_uri, GraphEntity.iri_has_sequence_identifier, "Journal Test"
        )

        # Volume 5 of the venue
        finder.add_triple(volume_uri, _RDF_TYPE, GraphEntity.iri_journal_volume)
        finder.add_triple(volume_uri, GraphEntity.iri_part_of, venue_uri)
        finder.add_triple(volume_uri, GraphEntity.iri_has_sequence_identifier, "5")

        # Issue 3 of volume 5
        finder.add_triple(issue_uri, _RDF_TYPE, GraphEntity.iri_journal_issue)
        finder.add_triple(issue_uri, GraphEntity.iri_part_of, volume_uri)
        finder.add_triple(issue_uri, GraphEntity.iri_has_sequence_identifier, "3")
...
class TestVVIQueryIsolation:
    ...
    def test_vvi_queries_only_search_correct_venues(self, vvi_endpoint):
        ...
        volume_10_uri = "https://w3id.org/oc/meta/br/9002"
        volume_20_uri = "https://w3id.org/oc/meta/br/9004"
        venue_a_uri = "https://w3id.org/oc/meta/br/9001"
        venue_b_uri = "https://w3id.org/oc/meta/br/9003"

        # Check that volume 10 is in local graph and is part of venue A (not venue B)
        assert finder.graph.has_subject(volume_10_uri)
        volume_10_parents = finder._get_objects(volume_10_uri, GraphEntity.iri_part_of)
        assert venue_a_uri in volume_10_parents, "Volume 10 should be part of Venue A"

        # Check that volume 20 is in local graph and is part of venue B (not venue A)
        assert finder.graph.has_subject(volume_20_uri)
        volume_20_parents = finder._get_objects(volume_20_uri, GraphEntity.iri_part_of)
        assert venue_b_uri in volume_20_parents, "Volume 20 should be part of Venue B"
...
class TestFinderRetrieveReFromBrMeta:
    ...
    def finder_with_re_data(self):
        ...
        br1_uri = f"{base_iri}/br/test1"
        re1_uri = f"{base_iri}/re/test1"
        finder.add_triple(br1_uri, GraphEntity.iri_embodiment, re1_uri)
        finder.add_triple(re1_uri, GraphEntity.iri_starting_page, "100")

        br2_uri = f"{base_iri}/br/test2"
        re2_uri = f"{base_iri}/re/test2"
        finder.add_triple(br2_uri, GraphEntity.iri_embodiment, re2_uri)
        finder.add_triple(re2_uri, GraphEntity.iri_ending_page, "200")
...
class TestFinderGetSubgraph:
    def test_get_subgraph_not_found(self):
        finder = ResourceFinder(FINDER_SERVER, FINDER_BASE_IRI)
        result = finder.graph.subgraph(f"{FINDER_BASE_IRI}br/nonexistent")
    ...
    def test_get_subgraph_reconstructs_uris(self):
        ...
        finder.add_triple(br, _RDF_TYPE, GraphEntity.iri_expression)
        finder.add_triple(br, GraphEntity.iri_has_identifier, id_uri)
        g = finder.graph.subgraph(br)
        assert g is not None
        triples = set(g)
        assert (br, _RDF_TYPE, RDFTerm("uri", GraphEntity.iri_expression)) in triples
        assert (br, GraphEntity.iri_has_identifier, RDFTerm("uri", id_uri)) in triples
    ...
    def test_get_subgraph_reconstructs_typed_literals(self):
        ...
        title = "A Test Title"
        date = "2025-01-15"
        finder.add_triple(br, GraphEntity.iri_title, title, o_datatype=_XSD_STRING)
        finder.add_triple(
            br,
            GraphEntity.iri_has_publication_date,
            date,
            o_datatype="http://www.w3.org/2001/XMLSchema#date",
        )
        g = finder.graph.subgraph(br)
        assert g is not None
        triples = set(g)
        assert (
            br,
            GraphEntity.iri_title,
            RDFTerm("literal", title, _XSD_STRING),
        ) in triples
        assert (
            br,
            GraphEntity.iri_has_publication_date,
            RDFTerm("literal", date, "http://www.w3.org/2001/XMLSchema#date"),
        ) in triples
        assert len(triples) == 2
    ...
    def test_get_subgraph_reconstructs_plain_literals(self):
        ...
        finder.add_triple(br, GraphEntity.iri_title, value)
        g = finder.graph.subgraph(br)
        assert g is not None
        triples = set(g)
        assert (
            br,
            GraphEntity.iri_title,
            RDFTerm("literal", value, _XSD_STRING),
        ) in triples

    def test_get_subgraph_accepts_string(self):
        finder = ResourceFinder(FINDER_SERVER, FINDER_BASE_IRI)
        br = f"{FINDER_BASE_IRI}br/0604"
        finder.add_triple(br, _RDF_TYPE, GraphEntity.iri_expression)
        assert finder.graph.subgraph(br) is not None
...
class TestFinderRetrieveVenueFromLocalGraphIssueDirectlyInVenue:
    def test_issue_directly_in_venue(self):
        ...
        venue_uri = f"{base_iri}/br/venue1"
        issue_uri = f"{base_iri}/br/issue1"
        finder.add_triple(issue_uri, _RDF_TYPE, GraphEntity.iri_journal_issue)
        finder.add_triple(issue_uri, GraphEntity.iri_part_of, venue_uri)
        finder.add_triple(issue_uri, GraphEntity.iri_has_sequence_identifier, "5")
...
class TestFinderRetrievePublisherDeepNesting:
    ...
    def finder_with_publisher_data(self):
        ...
        br_uri = f"{base_iri}/br/deep1"
        issue_uri = f"{base_iri}/br/issue1"
        vol_uri = f"{base_iri}/br/vol1"
        ar_uri = f"{base_iri}/ar/pub1"
        ra_uri = f"{base_iri}/ra/publisher1"
        ...
        finder.add_triple(ar_uri, GraphEntity.iri_is_held_by, ra_uri)
        finder.add_triple(ra_uri, GraphEntity.iri_name, "Deep Publisher")

        return finder

    def test_retrieve_publisher_two_levels_deep(self, finder_with_publisher_data):
        result = finder_with_publisher_data.retrieve_publisher_from_br_metaid(
            "br/deep1"
        )
...
class TestFinderRetrieveRaFromIdMultipleIds:
    ...
    def finder_with_ra_multiple_ids(self):
        ...
        ra_uri = f"{base_iri}/ra/multi1"
        id1_uri = f"{base_iri}/id/id1"
        id2_uri = f"{base_iri}/id/id2"
        finder.add_triple(ra_uri, GraphEntity.iri_has_identifier, id1_uri)
        finder.add_triple(
            id1_uri,
            GraphEntity.iri_uses_identifier_scheme,
            GraphEntity.DATACITE["orcid"],
        )
        finder.add_triple(
            id1_uri, GraphEntity.iri_has_literal_value, "0000-0001-1234-5678"
        )
        ...
        finder.add_triple(
            id2_uri,
            GraphEntity.iri_uses_identifier_scheme,
            GraphEntity.DATACITE["viaf"],
        )
        finder.add_triple(id2_uri, GraphEntity.iri_has_literal_value, "12345")

        finder.add_triple(ra_uri, GraphEntity.iri_name, "Multi ID Author")

        return finder

    def test_retrieve_ra_returns_all_ids(self, finder_with_ra_multiple_ids):
        result = finder_with_ra_multiple_ids.retrieve_ra_from_id(
