...
class TestCleaner:
    ...
    def test_clean_ra_list(self):
        names = [
            ...
            "Peroni, Not Available",
            "Not Available, Silvio",
            "Not Available",
            "Peroni, Silvio",
            ",",
        ]
    ...
    def test_clean_ra_list_duplicates(self):
        names = [
            "Peroni, Silvio [orcid:0000-0003-0530-4305 viaf:1]",
            "Peroni, Not Available",
    ...
    def test_clean_ra_list_remove_ids(self):
        names = [
            "Peroni, Silvio [orcid:0000-0003-0530-4305 viaf:1]",
            "Peroni, Not Available",
            "Perone, Silvio [orcid:0000-0003-0530-4305]",
            "Massari, Arcangelo",
        ]
        output = clean_ra_list(names)
        expected_output = [
            "Peroni, Silvio [viaf:1]",
            "Peroni, ",
            "Perone, Silvio",
            "Massari, Arcangelo",
        ]
    ...
    def test_clean_volume_and_issue(self):
        invalid_vi_rows = [
            ...
            {"pub_date": "", "volume": "", "issue": "Vol 2 Núm 3", "type": ""},
            {
                "pub_date": "",
                "volume": "",
                "issue": "Lang.- Lit. Volume 10 numéro 2",
                "type": "",
            },
            ...
            {
                "pub_date": "",
                "volume": "${articleBase.volume}",
                "issue": "Tập 55, Số 3",
                "type": "",
            },
            {
                "pub_date": "",
                "volume": "Issue 1 Volume 21, 2020",
                "issue": "",
                "type": "",
            },
            ...
            {"pub_date": "", "volume": "Cilt:13 Sayı:3", "issue": "", "type": ""},
            {
                "pub_date": "",
                "volume": "/",
                "issue": "Cilt 21 Sayı 3 Temmuz 2020",
                "type": "",
            },
            ...
            {"pub_date": "", "volume": "N?44", "issue": "N��49", "type": ""},
            {
                "pub_date": "",
                "volume": "N�1,NF",
                "issue": "85 (First Serie",
                "type": "",
            },
            {
                "pub_date": "",
                "volume": "issue 2",
                "issue": "Original Series, Volume 1",
                "type": "",
            },
            {
                "pub_date": "",
            ...
            {
                "pub_date": "",
                "volume": 'Special Issue "Urban Morphology”',
                "issue": "vol.7",
                "type": "",
            },
            ...
            {
                "pub_date": "",
                "volume": "(13/72) Language-Literature",
                "issue": "",
                "type": "",
            },
        ...
        expected_output = [
            ...
            {"pub_date": "", "volume": "44", "issue": "49", "type": ""},
            {
                "pub_date": "",
                "volume": "1,NF",
                "issue": "85 (First Series)",
                "type": "",
            },
            {
                "pub_date": "",
                "volume": "Original Series, Volume 1",
                "issue": "issue 2",
                "type": "",
            },
            {
            ...
            },
            {
                "pub_date": "",
                "volume": "vol.7",
                "issue": 'Special Issue "Urban Morphology”',
                "type": "",
            },
