...
class TestCurator:
    ...
    def test_clean_id(self):
        ...
        row = {
            "id": "doi:10.1001/archderm.104.1.106",
            "title": "Multiple Blasto",
            "author": "",
            "pub_date": "1971-07-01",
            "venue": "Archives Of Dermatology [omid:br/4416]",
            "volume": "",
            "issue": "",
            "page": "",
            "type": "",
        ...
        curator.finder.get_everything_about_res(
            metavals=set(), identifiers={"doi:10.1001/archderm.104.1.106"}, vvis=set()
        )
        curator.clean_id(row)
        expected_output = {
            "id": "br/3757",
            "title": "Multiple Keloids",
            "author": "",
            "pub_date": "1971-07-01",
            "venue": "Archives Of Dermatology [omid:br/4416]",
            "volume": "",
    ...
    def test_clean_ra_overlapping_surnames(self):
        ...
        row = {
            "id": "br/wannabe_0",
            "title": "Giant Oyster Mushroom Pleurotus giganteus (Agaricomycetes) Enhances Adipocyte Differentiation and Glucose Uptake via Activation of PPARγ and Glucose Transporters 1 and 4 in 3T3-L1 Cells",
            "author": "Paravamsivam, Puvaneswari; Heng, Chua Kek; Malek, Sri Nurestri Abdul [orcid:0000-0001-6278-8559]; Sabaratnam, Vikineswary; M, Ravishankar Ram; Kuppusamy, Umah Rani",
            "pub_date": "2016",
            "venue": "International Journal of Medicinal Mushrooms [issn:1521-9437]",
            "volume": "18",
            "issue": "9",
            "page": "821-831",
            "type": "journal article",
            "publisher": "Begell House [crossref:613]",
            "editor": "",
        }
        curator = prepareCurator(list())
        curator.entity_store.add_entity(
            "br/wannabe_0",
        ...
        curator.entity_store.add_id(
            "br/wannabe_0", "doi:10.1615/intjmedmushrooms.v18.i9.60"
        )
        curator.clean_ra(row, "author")
        expected_ardict = {
            "br/wannabe_0": {
                "author": [
                    ("ar/0601", "ra/wannabe_0"),
                    ("ar/0602", "ra/wannabe_1"),
                    ("ar/0603", "ra/wannabe_2"),
                    ("ar/0604", "ra/wannabe_3"),
                    ("ar/0605", "ra/wannabe_4"),
                    ("ar/0606", "ra/wannabe_5"),
                ],
                "editor": [],
                "publisher": [],
            }
        ...
        expected_ra_store = {
            ...
            "ra/wannabe_2": {
                "ids": {"orcid:0000-0001-6278-8559"},
                "title": "Malek, Sri Nurestri Abdul",
            },
        ...
        assert (
            curator.entity_store.get_id_metaid("orcid:0000-0001-6278-8559") == "id/0601"
        )
    ...
    def test_clean_ra_with_br_metaid(self):
        ...
        row = {
            "id": "doi:10.1001/archderm.104.1.106",
            "title": "Multiple Keloids",
            "author": "Curth, W.; McSorley, J. [orcid:0000-0003-0530-4305 schema:12345]",
            "pub_date": "1971-07-01",
            "venue": "Archives Of Dermatology [omid:br/4416]",
            "volume": "104",
            "issue": "1",
        ...
        expected_ardict = {
            "br/3757": {
                "author": [("ar/9445", "ra/6033"), ("ar/0601", "ra/wannabe_0")],
                "editor": [],
                "publisher": [],
            }
        }
        ...
        assert curator.entity_store.get_ids("ra/wannabe_0") == {
            "orcid:0000-0003-0530-4305",
            "schema:12345",
        }
        assert curator.entity_store.get_title("ra/wannabe_0") == "McSorley, J."
        assert (
            curator.entity_store.get_id_metaid("orcid:0000-0003-0530-4305") == "id/0601"
        )
    ...
    def test_clean_ra_with_br_wannabe(self):
        ...
        row = {
            "id": "br/wannabe_0",
            "title": "Multiple Keloids",
            "author": "Curth, W. [orcid:0000-0002-8420-0696] ; McSorley, J. [orcid:0000-0003-0530-4305]",
            "pub_date": "1971-07-01",
            "venue": "Archives Of Dermatology [omid:br/4416]",
            "volume": "104",
            "issue": "1",
        ...
        expected_ardict = {
            "br/wannabe_0": {
                "author": [("ar/0601", "ra/wannabe_1"), ("ar/0602", "ra/wannabe_2")],
                "editor": [],
                "publisher": [],
            }
        }
        assert curator.ardict == expected_ardict
        assert curator.entity_store.get_ids("ra/wannabe_1") == {
            "orcid:0000-0002-8420-0696"
        }
        assert curator.entity_store.get_title("ra/wannabe_1") == "Curth, W."
        assert curator.entity_store.get_ids("ra/wannabe_2") == {
            "orcid:0000-0003-0530-4305"
        }
        assert curator.entity_store.get_title("ra/wannabe_2") == "McSorley, J."
        assert (
            curator.entity_store.get_id_metaid("orcid:0000-0002-8420-0696") == "id/0601"
        )
        assert (
            curator.entity_store.get_id_metaid("orcid:0000-0003-0530-4305") == "id/0602"
        )
    ...
    def test_clean_vvi_all_data_on_ts(self):
        ...
        expected_output = {
            "br/4416": {
                "issue": {},
                "volume": {"104": {"id": "br/4712", "issue": {"1": {"id": "br/4713"}}}},
            }
        }
    ...
    def test_clean_vvi_new_venue(self):
        ...
        row = {
            "id": "br/wannabe_1",
            "title": "Money growth, interest rates, inflation and raw materials prices: China",
            "author": "",
            "pub_date": "2011-11-28",
            "venue": "OECD Economic Outlook",
            "volume": "2011",
    ...
    def test_clean_vvi_new_volume_and_issue(self):
        ...
        row = {
            ...
            "author": "",
            "pub_date": "",
            "venue": "Archives Of Surgery [omid:br/4480]",
            "volume": "147",
            "issue": "11",
            "page": "",
            "type": "journal article",
        ...
        expected_output = {
            "br/4480": {
                "issue": {},
                "volume": {
                    "147": {"id": "br/4481", "issue": {"11": {"id": "br/4482"}}}
                },
            }
        }
        assert curator.vvi == expected_output
        ...
        expected_output = [
            {
                ...
                "author": "",
                "pub_date": "",
                "venue": "OECD Economic Outlook [omid:br/0602]",
                "volume": "",
                "issue": "",
                "page": "",
                "type": "journal volume",
    ...
    def test_enricher(self):
        ...
        curator.entity_store.add_id(
            "br/wannabe_0", "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        )
        ...
        curator.ardict = {
            "br/wannabe_0": {
                "author": [],
                "editor": [],
                "publisher": [("ar/0601", "ra/wannabe_2")],
            }
        }
        curator.remeta = dict()
        curator.meta_maker()
        ...
        expected_output = [
            {
                "id": "doi:10.1787/eco_outlook-v2011-2-graph138-en omid:br/0601",
                "title": "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China",
                "author": "",
                "pub_date": "2011-11-28",
                "venue": "OECD Economic Outlook [omid:br/0602]",
                ...
                "page": "",
                "type": "",
                "publisher": "Oecd [crossref:1963 omid:ra/0601]",
                "editor": "",
            }
        ]
        for row in output:
    ...
    def test_equalizer(self):
        ...
        expected_row = {
            "id": "",
            "title": "",
            "author": "Curth, W. [omid:ra/6033]",
            "pub_date": "1971-07-01",
            "venue": "Archives Of Dermatology [omid:br/4416 issn:0003-987X]",
            "volume": "104",
            "issue": "1",
            "page": "106-107",
            "type": "journal article",
            "publisher": "American Medical Association (ama) [omid:ra/3309 crossref:10]",
            "editor": "",
        }
    ...
    def test_get_preexisting_entities(self):
        row = {
            "id": "omid:br/2715",
            "title": "Image Of The Year For 2012",
            "author": "",
            "pub_date": "",
            "venue": "Archives Of Surgery [omid:br/4480]",
            "volume": "99",
        ...
        expected_data = [
            {
                "id": "doi:10.1001/2013.jamasurg.202 omid:br/2715",
                "title": "Image Of The Year For 2012",
                "author": "",
                "pub_date": "2012-12-01",
                "venue": "Archives Of Surgery [issn:0004-0010 omid:br/4480]",
                "volume": "147",
                "issue": "12",
                "page": "1140-1140",
                "type": "journal article",
                "publisher": "American Medical Association (ama) [crossref:10 omid:ra/3309]",
                "editor": "",
            }
        ]
        expected_entities = {
    ...
    def test_indexer(self):
        ...
        curator.ardict = {
            "br/2585": {
                "author": [("ar/9445", "ra/0602"), ("ar/0601", "ra/0601")],
                "editor": [],
                "publisher": [],
            }
        }
        ...
        expected_index_id_br = [
            {"id": "doi:10.1001/2013.jamasurg.270", "meta": "id/2585"}
        ]
        expected_index_id_ra = [
            {"id": "orcid:0000-0003-0530-4305", "meta": "id/0601"},
            {"id": "viaf:12345", "meta": "id/0602"},
        ]
    ...
    def test_is_a_valid_row(self):
        rows = [
            ...
            {
                "id": "doi:10.1001/2013.jamasurg.270",
                "title": "",
                "author": "",
                "pub_date": "",
                "venue": "",
            ...
            },
            {
                "id": "",
                "title": "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China",
                "author": "Deckert, Ron J. [orcid:0000-0003-2100-6412]",
                "pub_date": "",
                "venue": "",
                "volume": "",
                "issue": "",
    ...
    def test_merge_duplicate_entities(self):
        ...
        data = [
            ...
            },
            {
                ...
                "author": "",
                "pub_date": "1971-07-03",
                "venue": "Archives Of Blast [omid:br/4416]",
                "volume": "105",
                "issue": "2",
                "page": "106-108",
                "type": "journal volume",
        ...
        curator.finder.get_everything_about_res(
            metavals=all_metavals, identifiers=all_identifiers, vvis=all_vvis
        )
        ...
        expected_data = [
            {
                ...
                "author": "Curth, W. [omid:ra/6033]",
                "pub_date": "1971-07-01",
                "venue": "Archives Of Dermatology [issn:0003-987X omid:br/4416]",
                "volume": "104",
                "issue": "1",
                "page": "106-107",
                "type": "journal article",
    ...
    def test_merge_entities_in_csv(self):
        ...
        curator.merge_entities_in_csv(
            ["doi:10.1787/eco_outlook-v2011-2-graph138-en"],
            "br/0601",
            "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China",
        )
        assert curator.entity_store.get_ids("br/0601") == {
            "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        }
        assert (
            curator.entity_store.get_title("br/0601")
            == "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China"
        )
        assert (
            curator.entity_store.get_id_metaid(
                "doi:10.1787/eco_outlook-v2011-2-graph138-en"
            )
            == "id/0605"
        )
    ...
    def test_meta_maker(self):
        ...
        curator.meta_maker()
        assert curator.entity_store.get_ids("br/3757") == {
            "doi:10.1001/archderm.104.1.106",
            "pmid:29098884",
        }
        ...
        assert curator.entity_store.get_title("ra/6033") == "Curth, W."
        assert curator.entity_store.get_ids("ra/0601") == {
            "orcid:0000-0003-0530-4305",
            "schema:12345",
        }
        ...
        expected_ardict = {
            "br/3757": {
                "author": [("ar/9445", "ra/6033"), ("ar/0601", "ra/0601")],
                "editor": [],
                "publisher": [],
            }
        }
...
def id_worker_finder():
    ...
    finder.get_everything_about_res(
        metavals={"omid:br/3309", "omid:br/2438", "omid:br/0601"},
        identifiers={
...
class TestIdWorker:
    def test_id_worker_1(self):
        ...
        assert curator.entity_store.get_ids("br/wannabe_0") == {
            "doi:10.1163/2214-8655_lgo_lgo_02_0074_ger"
        }
    ...
    def test_id_worker_2_id_ts(self, id_worker_finder):
        ...
        assert (
            curator.entity_store.get_title("ra/3309")
    ...
    def test_id_worker_conflict(self, id_worker_finder):
        ...
        assert (
            curator.entity_store.get_title("br/wannabe_0")
            == "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China"
        )
        assert (
            curator.entity_store.get_id_metaid("doi:10.1001/2013.jamasurg.270")
            == "id/2585"
        )
    ...
    def test_conflict_ra(self, id_worker_finder):
        ...
        assert (
            curator.entity_store.get_id_metaid("orcid:0000-0001-6994-8412") == "id/4475"
        )
    ...
    def test_conflict_suspect_id_among_existing(self, id_worker_finder):
        ...
        curator.entity_store.add_id(
            "br/0601", "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        )
        curator.entity_store.add_entity(
            "br/0602", "Contributions To GDP Growth And Inflation: South Africa"
        )
        curator.entity_store.add_id(
            "br/0602", "doi:10.1787/eco_outlook-v2011-2-graph150-en"
        )
        curator.entity_store.add_entity(
            "br/0603",
        ...
        curator.entity_store.add_id(
            "br/0603", "doi:10.1787/eco_outlook-v2011-2-graph18-en"
        )
    ...
    def test_conflict_suspect_id_among_wannabe(self, id_worker_finder):
        ...
        curator.entity_store.add_entity(
            "br/wannabe_2", "Contributions To GDP Growth And Inflation: South Africa"
        )
        curator.entity_store.add_id(
            "br/wannabe_2", "doi:10.1787/eco_outlook-v2011-2-graph150-en"
        )
        curator.entity_store.add_entity(
            "br/wannabe_3",
            "Official Loans To The Governments Of Greece, Ireland And Portugal",
        ...
        curator.entity_store.add_id(
            "br/wannabe_3", "doi:10.1787/eco_outlook-v2011-2-graph18-en"
        )
        name = "Money Growth, Interest Rates, Inflation And Raw Materials Prices: Japan"
        idslist = [
            "doi:10.1787/eco_outlook-v2011-2-graph138-en",
    ...
    def test_id_worker_4(self, id_worker_finder):
        ...
        assert (
            curator.entity_store.get_id_metaid("doi:10.1001/archderm.104.1.106")
            == "id/3624"
        )
...
class TestIdWorkerWithReset:
    def test_id_worker_2_meta_in_entity_store(self):
        ...
        curator_empty.finder.get_everything_about_res(
            metavals=set(),
            identifiers={"doi:10.1787/eco_outlook-v2011-2-graph138-en"},
            vvis=set(),
        )
        meta_id = curator_empty.id_worker(
            "id",
            name,
            [],
            "br/0601",
        ...
        assert curator_empty.entity_store.get_ids("br/0601") == {
            "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        }
        assert (
            curator_empty.entity_store.get_title("br/0601")
            == "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China"
        )
        assert (
            curator_empty.entity_store.get_id_metaid(
                "doi:10.1787/eco_outlook-v2011-2-graph138-en"
            )
            == "id/0601"
        )
    ...
    def test_conflict_existing(self):
        ...
        curator.entity_store.add_id(
            "br/0603", "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        )
        name = "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China"
    ...
    def test_id_worker_5(self):
        ...
        curator.entity_store.add_entity(
            "br/wannabe_1", "Contributions To GDP Growth And Inflation: South Africa"
        )
        curator.entity_store.add_id(
            "br/wannabe_1", "doi:10.1787/eco_outlook-v2011-2-graph150-en"
        )
        curator.entity_store.add_entity(
            "br/wannabe_2",
            "Official Loans To The Governments Of Greece, Ireland And Portugal",
        ...
        curator.entity_store.add_id(
            "br/wannabe_2", "doi:10.1787/eco_outlook-v2011-2-graph138-en"
        )
        name = "Money Growth, Interest Rates, Inflation And Raw Materials Prices: China"
        idslist = ["doi:10.1787/eco_outlook-v2011-2-graph138-en"]
        curator.wnb_cnt = 2
    ...
    def test_metaid_in_prov(self):
        ...
        add_data_ts(
            ...
            data_path=os.path.abspath(
                os.path.join("test", "testcases", "ts", "real_data_with_prov.nq")
            ).replace("\\", "/"),
        )
        name = ""
        curator = prepareCurator(list())
...
class TestCuratorMergeVolIssWithVvi:
    def test_merge_existing_volumes(self):
        ...
        curator.VolIss = {
            "br/venue1": {
                "volume": {
                    "10": {"id": "br/vol1", "issue": {"1": {"id": "br/issue1"}}}
                },
                "issue": {},
            }
        }
        ...
        curator.vvi = {
            "br/venue1": {
                "volume": {
                    "10": {"id": "br/vol1", "issue": {"2": {"id": "br/issue2"}}}
                },
        ...
        if col_name != "publisher" and metaval in curator.entity_store:
            ...
            if "," in name and "," in full_name:
                ...
                if not full_name.split(",")[1].strip() and first_name:
                    ...
                    curator.entity_store.set_title(
                        metaval, given_name + ", " + first_name
                    )
