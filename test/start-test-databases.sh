...
echo "Starting $VIRTUOSO_CONTAINER container..."
...
echo "Permissions set successfully in Virtuoso."
echo "Virtuoso SPARQL Endpoint: http://localhost:8805/sparql"
echo "Virtuoso ISQL Port: 1105"
